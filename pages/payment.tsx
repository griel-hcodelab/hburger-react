            ...
            <Title text={<h1>Pagamento</h1>} />
                <section>
                    ...
                    <form>
                        ...
                        <input type="text" name="number" placeholder="Número do Cartão" minLength={19} />

                        <div className="fields">
                            <div className="field">
                                <select name="validate_month" id="validate_month">
                                    <option value="0">Mês</option>
                                </select>
                            </div>
                            <div className="field">
                                <select name="validate_year" id="validate_year">
                                    <option value="0">Ano</option>
                                </select>
                            </div>
                            <div className="field">
                                <input type="text" name="code" placeholder="Código de Segurança" />
                            </div>
                        </div>
